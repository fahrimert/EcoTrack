...
@RestController
@CrossOrigin(origins = "*")
public class ManageBasedController {

public ManagerGraphService managerGraphService;
    public UserService userService;
    public SensorService sensorService;

    public ManageBasedController(ManagerGraphService managerGraphService,UserService userService,SensorService sensorService) {
