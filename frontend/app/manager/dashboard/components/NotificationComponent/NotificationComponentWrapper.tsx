...
const NotificationComponentWrapper = ({session,enrichedNotifications} : {session:RequestCookie | undefined , enrichedNotifications:  ManagerNotificationType
  }) => {
  const [notification,setNotification] = useState<ManagerNotificationType>(enrichedNotifications || [])
