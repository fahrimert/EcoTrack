...
import { workerTimeBasedStatsGraph } from "@/app/supervisor/superVizorDataTypes/types";
 ...
 const lastMonthPeriods = lastmonthdata.map((item) => item.period);
  ...
  return (
    <div className="w-full h-full p-[20px] flex flex-col">
      <h1 className="text-black text-[24px]">Tarihlere Göre SuperVizorlerinizin Verdiği Görevlerin Çözülme Oranı</h1>
