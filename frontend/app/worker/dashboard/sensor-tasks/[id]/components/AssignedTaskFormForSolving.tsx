...
const AssignedTaskFormForSolving = ({
  initialData,
  stasusesData,
}: {
        ...
        <div
          className={cn(
            `flex flex-col gap-[5px] w-full  rounded-[5px] ${
              !initialData.workerArriving && " blur-sm"
            }`
          )}
        >
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Textarea
                                  disabled={loading}
                                  placeholder="Arıza ile alakalı not ekleyin"
                                  {...field}
                                />
                              </FormControl>
                              <FormMessage />
